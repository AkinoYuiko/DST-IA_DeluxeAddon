...
env.AddSimPostInit(function()
    ...
    if env.GetModConfigData("nope_gem_ingredients") then
        -- anti-nope
        ...
        -- WX78
        set_ingredients("wx78module_light",             {Ingredient("scandata", 6), Ingredient(sw and "rainbowjellyfish_dead" or "lightbulb", 1)})
        ...
        set_ingredients("wx78module_taser",             {Ingredient("scandata", 5), Ingredient(sw and "jellyfish_dead" or "goatmilk", 1)})
        -- Wickerbottom
